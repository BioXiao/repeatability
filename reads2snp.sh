...
###./reads2snp_2.0.64.bin -bam ${1} -bamref ${2} -min 20 -nbth 8 -spa -bqt 20 -rqt 20 & # coverage 20
###./reads2snp_2.0.64.bin -bam ${1} -bamref ${2} -min 40 -nbth 8 -spa -bqt 20 -rqt 20 & # coverage 40
